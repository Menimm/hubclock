...
- במסך הדוחות נוסף מתג שמאפשר לכלול או להסתיר מזהי מכשירים גם בייצוא לאקסל, למקרי שימוש רגישים לפרטיות.
...
- במסך השעון נוספה מקלדת ספרות גדולה (דמוית מחשבון) לצד שדה הקוד, כך שבמכשירי טאץ' אפשר להקיש על ספרות 0–9, מחיקה וניקוי מלא בקלות; השדה עצמו כעת מאפשר קלט מספרי בלבד.
